                    ...
                    <div class="page-content">
                        <div class="container">
                            <ul class="page-breadcrumb breadcrumb">
                                ...
                                <li>
                                    <a href="<?php echo base_url('resources'); ?>">Recursos</a>
                                    <i class="fa fa-circle"></i>
                                </li>
                                <li>
                                        ...
                                        <div class="portlet light portlet-fit portlet-form ">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    ...
                                                    <span class="caption-subject font-dark sbold uppercase">Alta de Recurso</span>
                                                </div>
                                            </div>
                                            <div class="portlet-body">
                                                <?php echo get_bootstrap_alert(); ?>
                                                <?php echo validation_errors("<div class='alert alert-danger'>", "</div>"); ?>
                                                <?php echo form_open('resources/frm_editar', array('class' => 'horizontal-form', 'id' => 'form1')); ?>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <?php echo form_input('resource',set_value('resource', $recurso->resource), $data_nombre); ?>
                                                                <span class="help-block">Nombre del recurso</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-actions right">
                                                    <a type="button" class="btn default" href="<?php echo base_url('resources'); ?>">Cancelar</a>
