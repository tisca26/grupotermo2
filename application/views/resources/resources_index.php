                                    ...
                                    <div class="col-md-12">
                                        <div class="portlet light portlet-fit portlet-datatable ">
                                            <div class="portlet-title">
                                                <a type="button" class="btn btn-primary" href="<?php echo base_url('resources/insertar');?>"> <i class="fa fa-plus"></i> Agregar </a>
                                            </div>
                                            <div class="portlet-body">
                                                ...
                                                <table class="table table-striped table-bordered table-hover order-column"
                                                    ...
                                                    <?php foreach ($recursos as $recurso): ?>
                                                        <tr class="odd gradeX">
                                                            <td class="text-center"> <?php echo $recurso->resources_id; ?> </td>
                                                            <td class="text-center">
                                                                <?php echo $recurso->resource; ?>
                                                            </td>
                                                            <td class="text-center">
                                                                <div class="clearfix">
                                                                    <button class="btn btn-sm red btn_borrar"
                                                                            ...
                                                                            data-id="<?php echo $recurso->resources_id; ?>">
                                                                        Borrar <i class="fa fa-times"></i>
                                                                    </button>

                                                                    <a href="<?php echo base_url('resources/editar') . '/' . $recurso->resources_id; ?>" class="btn btn-sm blue">
...
<script>
    $(document).ready(function () {
        ...
        $('.btn_borrar').on('confirmed.bs.confirmation', function () {
            ...
            window.location.replace('<?php echo base_url()?>resources/borrar/' + $id);
        });
