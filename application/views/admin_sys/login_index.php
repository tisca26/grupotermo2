...
<head>
    ...
    <link href="<?php echo cdn_assets(); ?>global/plugins/select2/css/select2.min.css" rel="stylesheet"
          type="text/css"/>
    <link href="<?php echo cdn_assets(); ?>global/plugins/select2/css/select2-bootstrap.min.css" rel="stylesheet"
          type="text/css"/>
    ...
    <link href="<?php echo cdn_assets(); ?>pages/css/login.min.css" rel="stylesheet" type="text/css"/>
...
<div class="logo">
    <a href="index.html">
        <img src="<?php echo cdn_assets(); ?>pages/img/logo-big.png" alt=""/> </a>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<div class="content">
    ...
    <div class="alert alert-danger display-hide">
        ...
        <span> Ingresar nombre de usuario y contraseña. </span>
    </div>
    <div class="form-group">
        ...
        <input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off"
               placeholder="Usuario" name="nombre_usr"/></div>
    <div class="form-group">
        <label class="control-label visible-ie8 visible-ie9">Contraseña</label>
        <input class="form-control form-control-solid placeholder-no-fix" type="password" autocomplete="off"
               placeholder="Contraseña" name="pass_usr"/></div>
    <div class="form-actions">
        ...
        <a href="javascript:;" id="forget-password" class="forget-password">Olvidé Contraseña</a>
    </div>
    ...
    <form class="forget-form" action="index.html" method="post">
        ...
        <p> Ingrese su email para restaurar su contraseña. </p>
        <div class="form-group">
    ...
    <form class="register-form" action="index.html" method="post">
        <h3 class="font-green">Registrarse</h3>
        <p class="hint"> Ingrese sus datos personales: </p>
        <div class="form-group">
            <label class="control-label visible-ie8 visible-ie9">Nombre Completo</label>
            <input class="form-control placeholder-no-fix" type="text" placeholder="Nombre" name="fullname"/></div>
        <div class="form-group">
            <!--ie8, ie9 does not support html5 placeholder, so we just show field title for that-->
        ...
        <div class="form-group">
            ...
            <input class="form-control placeholder-no-fix" type="text" placeholder="Dirección" name="address"/></div>
        <div class="form-group">
            <label class="control-label visible-ie8 visible-ie9">Ciudad</label>
            <input class="form-control placeholder-no-fix" type="text" placeholder="Ciudad" name="city"/></div>
        <div class="form-group">
        ...
        <p class="hint"> Ingrese los detalles de su cuenta: </p>
        <div class="form-group">
            <label class="control-label visible-ie8 visible-ie9">Nombre de usuario</label>
        ...
        <div class="form-group">
            <label class="control-label visible-ie8 visible-ie9">Otra vez su contraseña</label>
            <input class="form-control placeholder-no-fix" type="password" autocomplete="off"
                   placeholder="Otra vez su contraseña" name="rpassword"/></div>
        <div class="form-group margin-top-20 margin-bottom-20">
            <label class="mt-checkbox mt-checkbox-outline">
                <input type="checkbox" name="tnc"/> Estoy de acuerdo con los
                <a href="javascript:;">Terminos de Servicio </a> &
...
<script src="<?php echo cdn_assets(); ?>global/plugins/jquery-validation/js/additional-methods.min.js"
        type="text/javascript"></script>
<script src="<?php echo cdn_assets(); ?>global/plugins/select2/js/select2.full.min.js" type="text/javascript"></script>
<!-- END PAGE LEVEL PLUGINS -->
<!-- BEGIN THEME GLOBAL SCRIPTS -->
<script src="<?php echo cdn_assets(); ?>global/scripts/app.min.js" type="text/javascript"></script>
<!-- END THEME GLOBAL SCRIPTS -->
<!-- BEGIN PAGE LEVEL SCRIPTS -->
<script src="<?php echo cdn_assets(); ?>pages/scripts/login.min.js" type="text/javascript"></script>
