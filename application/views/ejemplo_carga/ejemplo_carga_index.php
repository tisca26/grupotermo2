                                        ...
                                        <div class="portlet light portlet-fit portlet-form ">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    ...
                                                    <span class="caption-subject font-dark sbold uppercase">Ejemplo de la carga</span>
                                                </div>
                                            </div>
                                            <div class="portlet-body">
                                                ...
                                                <?php if (isset($hoja)): ?>
                                                    <pre><?php print_r( $hoja ); ?></pre>
                                                <?php endif;?>
                                                <?php echo form_open_multipart('ejemplo_carga/frm_insertar', array('class' => 'horizontal-form', 'id' => 'form1')); ?>
                                                <div class="form-body">
                                                                ...
                                                                <div class="fileinput fileinput-new"
                                                                    ...
                                                                    <div class="input-group input-large">
                                                                        ...
                                                                        <span class="input-group-addon btn default btn-file">
                                                                                    ...
                                                                                    <input type="file" name="input_file" accept=".xls,.xlsx" required> </span>
                                                                        <a href="javascript:;"
                                                ...
                                                <div class="form-actions right">
                                                    <a type="button" class="btn default"
                                                       href="<?php echo base_url(); ?>">Cancelar</a>
