                                    ...
                                    <div class="col-md-12">
                                        <div class="portlet light portlet-fit portlet-datatable ">
                                            <div class="portlet-title">
                                                <a type="button" class="btn btn-primary" href="<?php echo base_url('groups/insertar');?>"> <i class="fa fa-plus"></i> Agregar </a>
                                            </div>
                                            <div class="portlet-body">
                                                ...
                                                <table class="table table-striped table-bordered table-hover order-column"
                                                    ...
                                                    <thead>
                                                    <tr>
                                                        <th class="text-center"> Groups ID </th>
                                                    ...
                                                    <?php foreach ($grupos as $grupo): ?>
                                                        <tr class="odd gradeX">
                                                            <td class="text-center"> <?php echo $grupo->groups_id; ?> </td>
                                                            <td class="text-center"> <?php echo $grupo->nombre; ?> </td>
                                                            <td class="text-center" data-order = "<?php echo $grupo->estatus; ?>"> <?php $status = ((bool)$grupo->estatus)? 'check' : 'times'; ?><i class="fa fa-<?php echo $status; ?>"></i> </td>
                                                            <td class="text-center">
                                                                <div class="clearfix">
                                                                    <button class="btn btn-sm red btn_borrar"
                                                                            ...
                                                                            data-id="<?php echo $grupo->groups_id; ?>">
                                                                        Borrar <i class="fa fa-times"></i>
                                                                    </button>

                                                                    <a href="<?php echo base_url('groups/editar') . '/' . $grupo->groups_id; ?>" class="btn btn-sm blue">
                                                                        <i class="fa fa-file-o"></i> Editar </a>
                                                                    <a href="<?php echo base_url('acl/frm_acl/' . $grupo->groups_id . '/1'); ?>" class="btn btn-sm yellow">
...
<script>
    $(document).ready(function () {
        ...
        $('.btn_borrar').on('confirmed.bs.confirmation', function () {
            ...
            window.location.replace('<?php echo base_url()?>groups/borrar/' + $id);
        });
