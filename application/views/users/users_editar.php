                                    ...
                                    <div class="col-md-12">
                                        <div class="portlet light portlet-fit portlet-form ">
                                            ...
                                            <div class="portlet-body">
                                                ...
                                                <?php echo form_open('users/frm_editar', array('class' => 'horizontal-form', 'id' => 'form1')); ?>
                                                <input type="hidden" name="usuarios_id"
                                                       value="<?php echo $usuario->usuarios_id; ?>">
                                                <div class="form-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <?php echo form_input('email', set_value('email', $usuario->email), $data_email); ?>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <?php $data_contrasena = [
                                                                    'id' => 'passwd',
                                                                    'placeholder' => 'Ingrese el valor solo si desea cambiar la contraseña',
                                                                    'class' => 'form-control'
                                                                ]; ?>
                                                                <?php echo form_input('passwd', set_value('passwd'), $data_contrasena); ?>
                                                                <span class="help-block"> Ingrese el valor solo si desea cambiar la contraseña </span>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="mt-checkbox-list">
                                                                    <label class="mt-checkbox mt-checkbox-outline">
                                                                        ¿Activo?
                                                                        <?php echo form_checkbox('estatus', '1', (bool)$usuario->estatus); ?>
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="mt-checkbox-list" data-error-container="#frm1_grupos_error">
                                                                    <?php $grupos_id = explode(',', $usuario->grupos_id);?>
                                                                    <?php foreach ($grupos as $grupo): ?>
                                                                        <label class="mt-checkbox mt-checkbox-outline">
                                                                            <?php echo $grupo->nombre; ?>
                                                                            <input type="checkbox" name="groups[]"
                                                                                   value="<?php echo $grupo->groups_id; ?>" <?php echo set_checkbox('groups[]', $grupo->groups_id, in_array($grupo->groups_id, $grupos_id)); ?>
                                                                                   data-rule-required="true"
                                                                                   data-msg-required="Este campo es requerido"/>
                                                                            <span></span>
                                                                        </label>
