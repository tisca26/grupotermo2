                                        ...
                                        <div class="portlet light portlet-fit portlet-form ">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    ...
                                                    <span class="caption-subject font-dark sbold uppercase">Alta de Empresas</span>
                                                </div>
                                            </div>
                                            <div class="portlet-body">
                                                <?php echo get_bootstrap_alert(); ?>
                                                <?php echo validation_errors("<div class='alert alert-danger'>", "</div>"); ?>
                                                <?php echo form_open('empresas/frm_editar', array('class' => 'horizontal-form', 'id' => 'form1')); ?>
                                                <?php echo form_hidden('empresas_id', $empresa->empresas_id);?>
                                                <div class="form-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <?php echo form_input('rfc', set_value('rfc', $empresa->rfc), $data_rfc); ?>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <?php echo form_input('tel', set_value('tel', $empresa->tel), $data_telefono); ?>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="mt-checkbox-list">
                                                                    <label class="mt-checkbox mt-checkbox-outline">
                                                                        ¿Activo?
                                                                        <?php echo form_checkbox('estatus', '1', (bool) $empresa->estatus); ?>
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                ?>
                                                                <?php echo form_dropdown('cat_estados_id', $estados_sel, $empresa->cat_estados_id, $data_estados) ?>
                                                                <span class="help-block"> Ubicación de la empresa </span>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                ?>
                                                                <?php echo form_dropdown('cat_municipios_id',$municipios_sel , $empresa->cat_municipios_id, $data_municipio) ?>
                                                                <span class="help-block"> Ubicación de la empresa </span>
                                                            </div>
                                                        </div>
                                                    </div>
...
<script>
    $(document).ready(function () {
        $('#cat_estados_id').on('change', function(){
            ...
            var my_url = "<?php echo base_url('empresas/municipios_por_estado/'); ?>" + selected;
            $.get(
                my_url
            ).done(function (data) {
