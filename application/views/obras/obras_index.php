                                    ...
                                    <div class="col-md-12">
                                        <div class="portlet light portlet-fit portlet-datatable ">
                                            <div class="portlet-title">
                                                <a type="button" class="btn btn-primary" href="<?php echo base_url('obras/insertar');?>"> <i class="fa fa-plus"></i> Agregar </a>
                                            </div>
                                            <div class="portlet-body">
                                                ...
                                                <table class="table table-striped table-bordered table-hover order-column"
                                                    ...
                                                    <?php foreach ($obras as $obra): ?>
                                                        <tr class="odd gradeX">
                                                            <td class="text-center"> <?php echo $obra->obras_id; ?> </td>
                                                            <td class="text-center"> <?php echo $obra->nombre; ?> </td>
                                                            <td class="text-center"> <?php echo $obra->nombre_empresa; ?> </td>
                                                            <td class="text-center"> <?php echo $obra->nombre_cliente; ?> </td>
                                                            <td class="text-center" data-order = "<?php echo $obra->estatus; ?>"> <?php $status = ((bool)$obra->estatus)? 'check' : 'times'; ?><i class="fa fa-<?php echo $status; ?>"></i> </td>
                                                            <td class="text-center">
                                                                <div class="clearfix">
                                                                    ...
                                                                    <a href="<?php echo base_url('obras/editar') . '/' . $obra->obras_id; ?>" class="btn btn-sm blue">
...
<script>
    $(document).ready(function () {
        ...
        $('.btn_borrar').on('confirmed.bs.confirmation', function () {
            ...
            window.location.replace('<?php echo base_url()?>obras/borrar/' + $id);
        });
