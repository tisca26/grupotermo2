                    ...
                    <div class="page-content">
                        <div class="container">
                            <ul class="page-breadcrumb breadcrumb">
                                ...
                                <li>
                                    <span>Agregar Materiales y Servicios</span>
                                </li>
                            </ul>
                            <!-- --------------------------- INICIO CONTENIDO --------------------------- -->
                                    ...
                                    <div class="col-md-12">
                                        <div class="portlet light portlet-fit portlet-form ">
                                            ...
                                            <div class="portlet-body">
                                                ...
                                                <?php echo form_open('materiales_servicios/frm_insertar', array('class' => 'horizontal-form', 'id' => 'form1')); ?>
                                                <div class="form-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <?php echo form_input('descripcion', set_value('descripcion'), $data_descripcion); ?>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="mt-radio-inline">
                                                                    <label class="mt-radio">
                                                                        <input type="radio" name="tipo" id="tipo_material" value="1" checked> Material
                                                                        <span></span>
                                                                    </label>
                                                                    <label class="mt-radio">
                                                                        <input type="radio" name="tipo" id="tipo_servicio" value="0"> Servicio
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            </div>
