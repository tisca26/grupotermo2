                    ...
                    <div class="page-content">
                        <div class="container">
                            <ul class="page-breadcrumb breadcrumb">
                                ...
                                <li>
                                    <span>Editar Materiales para Acarreo</span>
                                </li>
                            </ul>
                            <!-- --------------------------- INICIO CONTENIDO --------------------------- -->
                                        ...
                                        <div class="portlet light portlet-fit portlet-form ">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    ...
                                                    <span class="caption-subject font-dark sbold uppercase">Alta de Materiales para Acarreo</span>
                                                </div>
                                            </div>
                                            <div class="portlet-body">
                                                <?php echo get_bootstrap_alert(); ?>
                                                <?php echo validation_errors("<div class='alert alert-danger'>", "</div>"); ?>
                                                <?php echo form_open('materiales_acarreos/frm_editar', array('class' => 'horizontal-form', 'id' => 'form1')); ?>
                                                <?php echo form_hidden('materiales_acarreos_id', $material_acarreo->materiales_acarreos_id); ?>
                                                <div class="form-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                ?>
                                                                <?php echo form_dropdown('obras_id', $obras_sel, $material_acarreo->obras_id, $data_obras) ?>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                ?>
                                                                <?php echo form_dropdown('proveedores_id', $proveedores_sel, $material_acarreo->proveedores_id, $data_proveedor) ?>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                ?>
                                                                <?php echo form_dropdown('materiales_servicios_id', $materiales_sel, $material_acarreo->materiales_servicios_id, $data_material) ?>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <?php echo form_input('nombre_en_obra', set_value('nombre_en_obra', $material_acarreo->nombre_en_obra), $data_nombre_obra); ?>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <?php echo form_input('ubicacion', set_value('ubicacion', $material_acarreo->ubicacion), $data_ubicacion); ?>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">
                                                                    <?php echo form_input('distancia_obra', set_value('distancia_obra', $material_acarreo->distancia_obra), $data_distancia_obra); ?>
                                                                    <span class="input-group-addon">
                                                                        <span> km </span>
                                                                    </span>
                                                                </div>
