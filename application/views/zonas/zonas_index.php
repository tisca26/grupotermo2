                                    ...
                                    <div class="col-md-12">
                                        <div class="portlet light portlet-fit portlet-datatable ">
                                            <div class="portlet-title">
                                                <a type="button" class="btn btn-primary" href="<?php echo base_url('zonas/insertar');?>"> <i class="fa fa-plus"></i> Agregar </a>
                                            </div>
                                            <div class="portlet-body">
                                                ...
                                                <table class="table table-striped table-bordered table-hover order-column"
                                                    ...
                                                    <?php foreach ($zonas as $zona): ?>
                                                        <tr class="odd gradeX">
                                                            <td class="text-center"> <?php echo $zona->zonas_id; ?> </td>
                                                            <td class="text-center"> <?php echo $zona->nombre; ?> </td>
                                                            <td class="text-center"> <?php echo $zona->obra_nombre; ?> </td>
                                                            <td class="text-center">
                                                                <div class="clearfix">
                                                                    ...
                                                                    <a href="<?php echo base_url('zonas/editar') . '/' . $zona->zonas_id; ?>" class="btn btn-sm blue">
...
<script>
    $(document).ready(function () {
        $('.btn_borrar').on('confirmed.bs.confirmation', function () {
            ...
            window.location.replace('<?php echo base_url()?>zonas/borrar/' + $id);
        });
