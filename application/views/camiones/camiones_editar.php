                                    ...
                                    <div class="col-md-12">
                                        <div class="portlet light portlet-fit portlet-form ">
                                            ...
                                            <div class="portlet-body">
                                                ...
                                                <?php echo form_open('camiones/frm_editar', array('class' => 'horizontal-form', 'id' => 'form1')); ?>
                                                <?php echo form_hidden('camiones_id', $camion->camiones_id); ?>
                                                <div class="form-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <?php $data_clave = [
                                                                    'id' => 'clave',
                                                                    'placeholder' => 'Clave del camion',
                                                                    'class' => 'form-control',
                                                                    'data-rule-required' => 'true',
                                                                    'data-msg-required' => 'Este campo es requerido'
                                                                ]; ?>
                                                                <?php echo form_input('clave', set_value('clave', $camion->clave), $data_clave); ?>
                                                                <span class="help-block"> Clave del camión </span>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <?php echo form_input('placa', set_value('placa', $camion->placa), $data_placa); ?>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <?php echo form_input('nombre_chofer', set_value('nombre_chofer', $camion->nombre_chofer), $data_chofer); ?>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                ?>
                                                                <?php echo form_dropdown('proveedores_id', $proveedores_sel, $camion->proveedores_id, $data_proveedores) ?>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">
                                                                    <?php echo form_input('capacidad', set_value('capacidad', $camion->capacidad), $data_capacidad); ?>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <?php echo form_input('fecha_cubicacion', set_value('fecha_cubicacion', $camion->fecha_cubicacion), $data_fecha_cubicacion); ?>
