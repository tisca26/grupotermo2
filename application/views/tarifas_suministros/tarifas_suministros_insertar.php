                                    ...
                                    <div class="col-md-12">
                                        <div class="portlet light portlet-fit portlet-form ">
                                            ...
                                            <div class="portlet-body">
                                                ...
                                                <?php echo form_open('tarifas_suministros/frm_insertar', array('class' => 'horizontal-form', 'id' => 'form1')); ?>
                                                <div class="form-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="mt-repeater">
                                                                <div data-repeater-list="tarifas-group">
                                                                ...
                                                                <a href="javascript:;" data-repeater-create
                                                                   class="btn btn-info mt-repeater-add">
                                                                    <i class="fa fa-plus"></i> Agregar Tarifa
                                                                </a>
                                                                <br>
                                                                <br>
                                                            </div>
