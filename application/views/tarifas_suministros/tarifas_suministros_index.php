                                    ...
                                    <div class="col-md-12">
                                        <div class="portlet light portlet-fit portlet-datatable ">
                                            <div class="portlet-title">
                                                <a type="button" class="btn btn-primary" href="<?php echo base_url('tarifas_suministros/insertar');?>"> <i class="fa fa-plus"></i> Agregar </a>
                                            </div>
                                            <div class="portlet-body">
                                                ...
                                                <table class="table table-striped table-bordered table-hover order-column"
                                                    ...
                                                    <tbody>
                                                    <?php foreach ($tarifas_suministros as $tarifa_suministro): ?>
                                                        <tr class="odd gradeX">
                                                            <td class="text-center"> <?php echo $tarifa_suministro->tarifas_suministros_id; ?> </td>
                                                            <td class="text-center"> <?php echo $tarifa_suministro->obra_nombre; ?> </td>
                                                            <td class="text-center"> <?php echo $tarifa_suministro->proveedor_nombre; ?> </td>
                                                            <td class="text-center"> <?php echo $tarifa_suministro->material_nombre_obra; ?> </td>
                                                            <td class="text-center"> <?php echo number_format($tarifa_suministro->costo, 2); ?> </td>
                                                            <td class="text-center">
                                                                <div class="clearfix">
                                                                    <button class="btn btn-sm red btn_borrar"
                                                                            ...
                                                                            data-id="<?php echo $tarifa_suministro->tarifas_suministros_id; ?>">
                                                                        Borrar <i class="fa fa-times"></i>
                                                                    </button>

                                                                    <a href="<?php echo base_url('tarifas_suministros/editar') . '/' . $tarifa_suministro->tarifas_suministros_id; ?>" class="btn btn-sm blue">
...
<script>
    $(document).ready(function () {
        ...
        $('.btn_borrar').on('confirmed.bs.confirmation', function () {
            ...
            window.location.replace('<?php echo base_url()?>tarifas_suministros/borrar/' + $id);
        });
