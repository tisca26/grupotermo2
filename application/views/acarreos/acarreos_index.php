                                                ...
                                                <table class="table table-striped table-bordered table-hover order-column"
                                                    ...
                                                    <?php foreach ($acarreos as $acarreo): ?>
                                                        <tr class="odd gradeX">
                                                            ...
                                                            <td class="text-center"> <?php echo $acarreo->zona_nombre; ?> </td>
                                                            <td class="text-center">
                                                                <div class="clearfix">
                                                                    <button class="btn btn-sm red btn_borrar"
                                                                            ...
                                                                            data-id="<?php echo $acarreo->acarreos_id; ?>">
                                                                        Borrar <i class="fa fa-times"></i>
                                                                    </button>

                                                                    <a href="<?php echo base_url('acarreos/editar') . '/' . $acarreo->acarreos_id; ?>" class="btn btn-sm blue">
...
<script>
    $(document).ready(function () {
        $('.btn_borrar').on('confirmed.bs.confirmation', function () {
            ...
            window.location.replace('<?php echo base_url()?>acarreos/borrar/' + $id);
        });
