                                    ...
                                    <div class="col-md-12">
                                        <div class="portlet light portlet-fit portlet-form ">
                                            ...
                                            <div class="portlet-body">
                                                ...
                                                <?php echo form_open('acarreos/frm_insertar', array('class' => 'horizontal-form', 'id' => 'form1')); ?>
                                                <div class="form-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <?php echo form_input('folio_vale', set_value('folio_vale'), $data_folio); ?>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group date form_datetime form_datetime bs-datetime">
                                                                    <?php echo form_input('fecha_acarreo', set_value('fecha_acarreo'), $data_fecha_acarreo); ?>
                                                                ...
                                                                <div class="mt-radio-inline">
                                                                    <label class="mt-radio">
                                                                        <input type="radio" name="tipo_acarreo"
                                                                               id="tipo_externo" value="EXTERNO"
                                                                               checked> Externo
                                                                        <span></span>
                                                                    </label>
                                                                    <label class="mt-radio">
                                                                        <input type="radio" name="tipo_acarreo"
                                                                               id="tipo_interno" value="INTERNO">
                                                                        Interno
                                                                        <span></span>
                                                                    </label>
                                                                </div>
