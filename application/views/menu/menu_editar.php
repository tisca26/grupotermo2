                                    ...
                                    <div class="col-md-12">
                                        <div class="portlet light portlet-fit portlet-form ">
                                            ...
                                            <div class="portlet-body">
                                                ...
                                                <?php echo form_open('menu/frm_editar', array('class' => 'horizontal-form', 'id' => 'form1')); ?>
                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <?php echo form_input('shortdesc', set_value('shortdesc', $menu->shortdesc), $data_desc_cor); ?>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="control-label">Menú padre <span
                                                                            class="required"> * </span></label>
                                                                <?php echo form_dropdown('parent_id', $menus, $menu->parent_id, 'required class="selectpicker form-control" data-live-search="true" data-size="8" title=" - Seleccione -" data-live-search-normalize="true"') ?>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="mt-checkbox-list">
                                                                    <label class="mt-checkbox mt-checkbox-outline">
                                                                        ¿Activo?
                                                                        <?php echo form_checkbox('estatus', '1', (bool)$menu->estatus); ?>
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="mt-radio-inline">
                                                                <label class="mt-radio">
                                                                    <input type="radio" name="radio_url" id="radio_res"
                                                                           value="0" <?php echo $radio_res; ?>> Enlace por recurso
                                                                    <span></span>
                                                                </label>
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <?php echo form_dropdown('resource_id', $recursos, ($menu->resource_id != null) ? $menu->resource_id : '', 'required id="resource_id" class="selectpicker form-control" data-live-search="true" data-size="8" title=" - Seleccione -" data-live-search-normalize="true"') ?>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <?php echo form_input('page_res', set_value('page_res', $page_res), 'id="page_res" class="form-control" placeholder="Enlace adicional al recurso"'); ?>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="mt-radio-inline">
                                                                <label class="mt-radio">
                                                                    <input type="radio" name="radio_url" id="radio_url"
                                                                           value="1" <?php echo $radio_url; ?>> Enlace personalizado
                                                                    <span></span>
                                                                </label>
                                                            </div>
                                                            <div class="form-group">
                                                                ...
                                                                <?php echo form_input('page_uri', set_value('page_uri', ($menu->resource_id == null)? $menu->page_uri : ''), $data_enlace_estandar); ?>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <?php echo form_input('icon', set_value('icon', $menu->icon), $data_icono); ?>
