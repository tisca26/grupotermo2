...
<head>
    ...
    <link href="<?php echo cdn_assets(); ?>pages/css/error.min.css" rel="stylesheet" type="text/css" />
                            ...
                            <div class="page-content-inner">
                                <div class="row">
                                    <div class="col-md-12 page-500">
                                        ...
                                        <div class=" details">
                                            <h3>¡Oops! Algo pasó.</h3>
                                            <p> Por favor regresa al inicio, gracias.
                                                <br/></p>
                                            <p>
                                                <a href="<?php echo base_url(); ?>" class="btn red btn-outline"> Regresar a Inicio </a>
                                                <br></p>
                                        </div>
                                    </div>
                                </div>
