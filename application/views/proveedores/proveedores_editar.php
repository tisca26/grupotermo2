                                    ...
                                    <div class="col-md-12">
                                        <div class="portlet light portlet-fit portlet-form ">
                                            ...
                                            <div class="portlet-body">
                                                ...
                                                <?php echo form_open('proveedores/frm_editar', array('class' => 'horizontal-form', 'id' => 'form1')); ?>
                                                <?php echo form_hidden('proveedores_id', $proveedor->proveedores_id);?>
                                                <div class="form-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <?php echo form_input('nombre', set_value('nombre', $proveedor->nombre), $data_nombre); ?>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <?php echo form_input('rfc', set_value('rfc', $proveedor->rfc), $data_rfc); ?>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <?php echo form_input('contacto', set_value('contacto', $proveedor->contacto), $data_contacto); ?>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <?php echo form_input('tel', set_value('tel', $proveedor->tel), $data_telefono); ?>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="mt-checkbox-list">
                                                                    <label class="mt-checkbox mt-checkbox-outline">
                                                                        ¿Activo?
                                                                        <?php echo form_checkbox('estatus', '1', (bool) $proveedor->estatus); ?>
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                ?>
                                                                <?php echo form_dropdown('cat_estados_id', $estados_sel, $proveedor->cat_estados_id, $data_estados) ?>
                                                                <span class="help-block"> Ubicación de la proveedor </span>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                ?>
                                                                <?php echo form_dropdown('cat_municipios_id',$municipios_sel , $proveedor->cat_municipios_id, $data_municipio) ?>
                                                                <span class="help-block"> Ubicación de la proveedor </span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                ?>
                                                                <?php echo form_dropdown('cat_bancos_id', $bancos_sel, $proveedor->cat_bancos_id, $data_bancos) ?>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <?php echo form_input('sucursal', set_value('sucursal', $proveedor->sucursal), $data_sucursal); ?>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <?php echo form_input('cuenta', set_value('cuenta', $proveedor->cuenta), $data_cuenta); ?>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <?php echo form_input('clabe', set_value('clabe', $proveedor->clabe), $data_clabe); ?>
