                                    ...
                                    <div class="col-md-12">
                                        <div class="portlet light portlet-fit portlet-datatable ">
                                            <div class="portlet-title">
                                                <a type="button" class="btn btn-primary" href="<?php echo base_url('empresas/insertar');?>"> <i class="fa fa-plus"></i> Agregar </a>
                                            </div>
                                            <div class="portlet-body">
                                                ...
                                                <table class="table table-striped table-bordered table-hover order-column"
                                                    ...
                                                    <?php foreach ($empresas as $empresa): ?>
                                                        <tr class="odd gradeX">
                                                            <td class="text-center"> <?php echo $empresa->empresas_id; ?> </td>
                                                            <td class="text-center"> <?php echo $empresa->nombre; ?> </td>
                                                            <td class="text-center"> <?php echo $empresa->rfc; ?> </td>
                                                            <td class="text-center" data-order = "<?php echo $empresa->estatus; ?>"> <?php $status = ((bool)$empresa->estatus)? 'check' : 'times'; ?><i class="fa fa-<?php echo $status; ?>"></i> </td>
                                                            <td class="text-center">
                                                                <div class="clearfix">
                                                                    <button class="btn btn-sm red btn_borrar"
                                                                            ...
                                                                            data-id="<?php echo $empresa->empresas_id; ?>">
                                                                        Borrar <i class="fa fa-times"></i>
                                                                    </button>

                                                                    <a href="<?php echo base_url('empresas/editar') . '/' . $empresa->empresas_id; ?>" class="btn btn-sm blue">
...
<script>
    $(document).ready(function () {
        ...
        $('.btn_borrar').on('confirmed.bs.confirmation', function () {
            ...
            window.location.replace('<?php echo base_url()?>empresas/borrar/' + $id);
        });
